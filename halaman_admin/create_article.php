                ...
                <div class="card-body">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul_article" class="form-control" placeholder="Tambahkan Judul article">
                        </div>
                        <div class="mb-3">
                            <label for="">Slug Article</label>
                            <input type="text" name="slug_article" class="form-control" placeholder="Tambahkan Slug article">
                        </div>
                        <div class="mb-3">
                            <label for="">Deskripsi article</label>
                            <textarea name="deskripsi_article" cols="30" rows="10" placeholder="Tambahkan Deskripsi article" class="form-control"></textarea>
                        </div>
                        <div class="mb-3">
